...
export default function GoogleSignInButton({ role, onSuccess, onError }: GoogleSignInButtonProps) {
  ...
  const handleButtonClick = () => {
    ...
    const state = `role:${role}|redirect:${encodeURIComponent(window.location.pathname)}`
